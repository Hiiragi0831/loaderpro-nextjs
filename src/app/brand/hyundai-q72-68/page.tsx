...
export async function generateMetadata() {
  ...
  return metaGen(
    "Запчасти для погрузчиков HYUNDAI",
    "Предлагаем купить запчасти для вилочных погрузчиков HYUNDAI с доставкой по всей России у проверенного поставщика в компании СПЕЦМАШИНА",
  );
}
      ...
      <section className="brand">
        <div className="container">
          <div className="brand__header">
            <div className="text">
              <h2 className={"h1"}>
                Запчасти для вилочных погрузчиков Hyundai (Хундай)
              </h2>
              <p>
