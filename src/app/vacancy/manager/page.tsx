          ...
          <div className="vacancy-inner__body">
            <div className="vacancy-inner__info">
              <div className="vacancy-inner__info-text">
                ...
                <p>
                  <b>
                    «СПЕЦМАШИНА» - поставщик складской техники, а также всех
                    необходимых деталей для профессионального ремонта и
                    обслуживания. Мы работаем на рынке складской техники уже
                    более 7-и лет. Нашей компании доверяют многие клиенты из
                    разных точек России и стран СНГ.
                  </b>
                </p>
                <p>
                  В связи с развитием и расширением отдела продаж, приглашаем в
                  свою команду Менеджера по продажам и работе с клиентами!
                </p>
              </div>
            ...
            <div className="vacancy-inner__conditions">
              <div className="vacancy-inner__condition">
                ...
                <blockquote>
                  <p>
                    Адрес офиса: БЦ Интертерминал ул. Кубинская д 75 к 1 (ст.
                    метро Московская, Ленинский пр.)
                  </p>
                  <p>График работы: 09:00 до 17:00, 5/2 сб и вс - выходные</p>
                  <p>Корпоративное обучение и повышение квалификации</p>
                  <p>
                    Среднемесячный доход от 90 000 руб. (оклад + % + премия)
                  </p>
              ...
              <div className="vacancy-inner__condition">
                ...
                <blockquote>
                  ...
                  <p>
                    Отличные коммуникативные навыки, активность, инициативность
                  </p>
              ...
              <div className="vacancy-inner__condition">
                ...
                <blockquote>
                  <p>
                    Работа с входящим потоком звонков и заявок (нет холодных
                    звонков!)
                  </p>
