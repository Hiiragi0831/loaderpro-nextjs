      ...
      <section className="page-text">
        <div className="container">
          <h1>
            ...
            &quot;СПЕЦМАШИНА&ldquo; в отношении обработки персональных данных
          </h1>
          ...
          <p>
            ...
            персональных данных&ldquo; (далее - Закон о персональных данных) в
          ...
          <p>
            ...
            &quot;СПЕЦМАШИНА&ldquo; (далее - Оператор, ООО
            &quot;СПЕЦМАШИНА&ldquo;).
          </p>
          <p>
          ...
          <p>
            ...
            Российской Федерации и нормативных актов ООО &quot;СПЕЦМАШИНА&ldquo;
            в сфере обработки и защиты персональных данных определяется в
          ...
          <ol>
            <li>
              ...
              &quot;СПЕЦМАШИНА&ldquo;, в том числе заключение и исполнение
            ...
            <li>
              ...
              работникам в трудоустройстве, получении образования и продвижении
              по службе, привлечение и отбор кандидатов на работу у Оператора,
              ...
              ведение кадрового и бухучета, заполнение и передача в
              уполномоченные органы требуемых форм отчетности, организация
              постановки на индивидуальный (персонифицированный) учет работников
          ...
          <ul>
            ...
            <li>
              Федеральный закон от 08.02.1998 N 14-ФЗ &laquo;Об обществах с
              ограниченной ответственностью&raquo;;
            </li>
            <li>
              Федеральный закон от 06.12.2011 N 402-ФЗ &laquo;О бухгалтерском
              учете&raquo;;
            </li>
            <li>
              Федеральный закон от 15.12.2001 N 167-ФЗ &laquo;Об обязательном
              пенсионном страховании в Российской Федерации&raquo;;
            </li>
            <li>
              Федеральный закон от 27.07.2006 г. № 149-ФЗ &laquo;Об информации,
              информационных технологиях и о защите информации&raquo;;
            </li>
            <li>
              Федеральный закон от 27.07.2006 г. № 152-ФЗ &laquo;О персональных
              данных&raquo;;
            </li>
            <li>
              Постановление Правительства Российской Федерации от 01.11.2012 г.
              № 1119 &laquo;Об утверждении требований к защите персональных
              данных при их обработке в информационных системах персональных
              данных&raquo;;
            </li>
            <li>
              Приказ Федеральной службы по техническому и экспортному контролю
              от 18.02.2013 г. № 21 &laquo;Об утверждении Состава и содержания
            ...
            <li>
              ...
              № 687 &laquo;Об утверждении положения об особенностях обработки
          ...
          <ul>
            <li>Устав ООО &quot;СПЕЦМАШИНА&ldquo;;</li>
          ...
          <p>
            ...
            &quot;СПЕЦМАШИНА&ldquo;, осуществления пропускного режима:
          </p>
          <ul>
            <li>фамилия, имя, отчество;</li>
            <li>дата и место рождения;</li>
          ...
          <p>
            ...
            соответствии с уставом ООО &quot;СПЕЦМАШИНА&ldquo;, осуществления
            пропускного режима:
          </p>
          <ul>
            <li>фамилия, имя, отчество;</li>
          ...
          <p>
            4.2.6 Посетители Сайта; зарегистрированные пользователи Сайта;
            физические лица - клиенты Общества, приобретающие у Общества товары
            и услуги, в том числе с использованием Сайта; представители и
            работники юридических лиц &ndash; клиентов Общества &ndash; для
            осуществления Обществом предпринимательской деятельности путем
            реализации товаров и услуг с использованием Сайта, в том числе для
            целей: регистрации и обслуживания аккаунта (личного кабинета)
            клиента на Сайте; информирования клиента о товарах и услугах, а
            также о проводимых акциях, конкурсах и иных стимулирующих
            мероприятиях; улучшение пользовательского взаимодействия с сайтом и
            повышения комфорта его использования, в том числе формирования
            наилучшей подборки или списка товаров в соответствии с
            предпочтениями пользователя; реализации клиенту товаров и услуг;
            проведения рекламных акцией, организации конкурсов, розыгрышей и
            иных стимулирующих мероприятий (в том числе определение победителей,
            доставка призов); участия клиента в программах лояльности;
            предоставления клиентам возможности оставлять отзывы на Сайте, а
            также возможности ознакомления с отзывами других клиентов;
            обеспечения связи с клиентом, установления с клиентом обратной
            связи, в том числе предоставления клиенту возможности направления
            уведомлений, сообщений, запросов и информации, касательно
            использования Сайта и возможности приобретения товаров на Сайте,
            предоставления клиентам возможности получения клиентской поддержки
            по телефону горячей линии и по электронной почте; &nbsp;направления
            клиентам информационных сообщений о товарах и услугах, о
            мероприятиях, организуемых Обществом, о товарах, работах, услугах
            партнеров Общества и третьих лиц; &nbsp;проведения Обществом опросов
            и маркетинговых исследований через Сайт и клиентские службы
            Общества; использования cookies для идентификации зарегистрированных
            пользователей Сайта, ведения статистики о пользователях Сайта и их
            запросах, подсчета количества посетителей Сайта и оценки технических
            возможностей Сайта; &nbsp;проведения Обществом статистических и иных
            исследований через Сайт и клиентские службы Общества на основе
          ...
          <ul>
            ...
            <li>
              данные из файлов cookie, пользовательские данные (IP-адрес; тип
              используемого устройства; операционная система устройства и тип
              браузера; источник захода на сайт и информация поискового или
              рекламного запроса; пользовательские клики; просмотры страниц,
              заполнения полей; показы и просмотры баннеров и видео; параметры
              сессии; данные о времени посещения; идентификатор пользователя,
              хранимый в cookie; данные, характеризующие аудиторные сегменты).
              Сбор указанных данных может осуществляться в том числе с
              использованием метрических программных средств, включая Яндекс
              Метрику и Google Analytics. При использовании указанного
              программного обеспечения возможна трансграничная передача
              персональных данных;
            </li>
            <li>
              иная информация, относящаяся к личности клиента/пользователя,
              которую клиент/пользователь пожелает оставить на Сайте.
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            &quot;СПЕЦМАШИНА&ldquo; в течение сроков хранения документов, для
            которых эти сроки предусмотрены законодательством об архивном деле в
            РФ (Федеральный закон от 22.10.2004 N 125-ФЗ &quot;Об архивном деле
            в Российской Федерации&ldquo;, Перечень типовых управленческих
            архивных документов, образующихся в процессе деятельности
            государственных органов, органов местного самоуправления и
            организаций, с указанием сроков их хранения (утв. Приказом Росархива
            от 20.12.2019 N 236)).
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              подтверждения того, что персональные данные получены незаконно или
              не являются необходимыми для заявленной цели обработки, - в
          ...
          <p>
            7.1 Общество периодически актуализирует настоящую Политику и вправе
            в одностороннем порядке в любой момент изменять её условия. При
            этом, Общество не обязано уведомлять субъектов персональных данных о
            внесённых изменениях. Общество рекомендует субъектам персональных
            данных самостоятельно отслеживать настоящую Политику на предмет
            возможных изменений.
          </p>
        </div>
      </section>
