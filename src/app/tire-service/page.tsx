      ...
      <section className="tireservice__hero">
        <div className="container">
          ...
          <picture className="for-devices">
            ...
            <img src={`/images/tireservice/hero-m.jpg`} alt="" decoding="async" />
          </picture>
        </div>
      </section>
      <section className="tireservice__pressing">
        <div className="container">
          <div className="row col-2">
            ...
            <div className="image">
              <picture>
                <source srcSet={`/images/tireservice/shinomontazh-lityh-shin-1.png`} />
                <img src={`/images/tireservice/shinomontazh-lityh-shin-1.png`} alt="" decoding="async" />
              </picture>
            </div>
          </div>
        </div>
          ...
          <div className="row col-2">
            <div className="image">
              <picture>
                ...
                <img src={`/images/tireservice/remont.png`} alt="" decoding="async" />
              </picture>
            </div>
            <div className="text">
          ...
          <div className="row col-2">
            ...
            <div className="image">
              <picture>
                ...
                <img src={`/images/tireservice/to-1.png`} alt="" decoding="async" />
              </picture>
            </div>
          </div>
        </div>
