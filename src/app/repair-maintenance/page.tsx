      ...
      <section className="repairmaintenance__hero">
        <div className="container">
          <picture className="for-desktop">
            ...
            <img src={`/images/repairmaintenance/hero.jpg`} alt="" decoding="async" />
          </picture>
          <picture className="for-devices">
            <source srcSet={`/images/repairmaintenance/hero-m.jpg`} />
            <img src={`/images/repairmaintenance/hero-m.jpg`} alt="" decoding="async" />
          </picture>
        </div>
      </section>
          ...
          <div className="row col-2">
            ...
            <div className="image">
              <picture>
                ...
                <img src={`/images/repairmaintenance/about.png`} alt="" decoding="async" />
              </picture>
            </div>
          </div>
        </div>
          ...
          <div className="row col-2">
            <div className="image">
              <picture>
                ...
                <img src={`/images/repairmaintenance/reglament.png`} alt="" decoding="async" />
              </picture>
            </div>
            <div className="text">
          ...
          <div className="row col-2">
            ...
            <div className="image">
              <picture>
                ...
                <img src={`/images/repairmaintenance/maintenance.jpg`} alt="" decoding="async" />
              </picture>
          ...
          <div className="row col-2">
            <div className="image">
              <picture>
                ...
                <img src={`/images/repairmaintenance/price.jpg`} alt="" decoding="async" />
              </picture>
            </div>
            <div className="text">
