        ...
        <div className="container">
          ...
          <div className="deliverypayment__head">
            <blockquote>
              ...
              <p>
                Доставка по Санкт-Петербургу в пределах КАД при заказе от 10 000
                руб. - бесплатно
              </p>
              <p>
                Доставка по Санкт-Петербургу в пределах КАД при заказе до 10 000
                руб. - 350 руб., за КАД + 20 руб./км
              </p>
            </blockquote>
          ...
          <div className="deliverypayment__body">
            ...
            <p>
              Оплата банковскими картами осуществляется через АО «Тинькофф
              Банк». К оплате принимаются карты VISA, MasterCard, МИР.
            </p>
            <p>
