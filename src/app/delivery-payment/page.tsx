      ...
      <section className="deliverypayment">
        <div className="container">
          ...
          <div className="deliverypayment__head">
            <blockquote>
              <p>
                Доставка осуществляется по всей России и странам СНГ по тарифам
                транспортных компаний
              </p>
              <p>
                Доставка до терминала любой транспортной компании в г.
                Санкт-Петербург – бесплатно
              </p>
              <p>
                Доставка по Санкт-Петербургу в пределах КАД при заказе от 50 000
                руб. - бесплатно
              </p>
              <p>
                Доставка по Санкт-Петербургу в пределах КАД при заказе до 50 000
                руб. - 500 руб., за КАД + 20 руб./км
              </p>
            </blockquote>
            <div className="deliverypayment__logo">
              <IconLogo />
            </div>
          </div>
          <div className="deliverypayment__body">
            <span className="h1">
              Правила оплаты и безопасность платежей,
              <br /> конфиденциальность информации
            </span>
            <h2>Безналичная оплата</h2>
            <p>Оплата по безналичному расчёту осуществляется с НДС 22%</p>
            <h2>Оплата банковской картой</h2>
            <p>
              Оплата банковскими картами осуществляется через АО «ТБанк». К
            ...
            <p>
              ...
              осуществляется на защищенной платежной странице АО «ТБанк».
            </p>
            <p>
              На странице для ввода данных банковской карты потребуется ввести
              данные банковской карты: номер карты, имя владельца карты, срок
              действия карты, трёхзначный код безопасности (CVV2 для VISA, CVC2
              для MasterCard, Код Дополнительной Идентификации для МИР). Все
            ...
            <p>
              ...
              кода безопасности, который придет к Вам в СМС. Если код
              безопасности к Вам не пришел, то следует обратиться в банк
              выдавший Вам карту.
            </p>
          </div>
          <div className="deliverypayment__footer">
            <div>
              ...
              <ul>
                ...
                <li>
                  Недостаточно средств для оплаты на банковской карте. Подробнее
                  о наличии средств на банковской карте Вы можете узнать,
                ...
                <li>
                  ...
                  которого действительна карта). Подробнее о сроке действия
            ...
            <div className="deliverypayment__info">
              ...
              <div className="deliverypayment__important">
                <p>
                  ...
                  телефонам: 8 (800) 55-11-996
                </p>
              </div>
              <small>
                <b>*</b>Предоставляемая вами персональная информация (имя,
                адрес, телефон, e-mail, номер банковской карты) является
